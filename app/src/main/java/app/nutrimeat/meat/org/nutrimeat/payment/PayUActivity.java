...
public class PayUActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            mPostData=bundle.getString("postData");
            mTxnId=bundle.getString("txn");
        }
        ...
        //Let us add some callbacks for Custom Browser
         PayUCustomBrowserCallback payUCustomBrowserCallback = new PayUCustomBrowserCallback() {
            ...
            public void setCBProperties(WebView webview, Bank payUCustomBrowser) {
                ...
                webview.postUrl(BuildConfig.PAYU_URL, mPostData.getBytes());
            }
            ...
            public void initializeMagicRetry(Bank payUCustomBrowser, WebView webview, MagicRetryFragment magicRetryFragment) {
                ...
                urlList.put(BuildConfig.PAYU_URL, mPostData);
                payUCustomBrowser.setMagicRetry(urlList);
            }
        };

        //Sets the configuration of custom browser
        CustomBrowserConfig customBrowserConfig = new CustomBrowserConfig(BuildConfig.MERCHANT_KEY,mTxnId);
        ...
        new CustomBrowser().addCustomBrowser(PayUActivity.this,customBrowserConfig , payUCustomBrowserCallback);
